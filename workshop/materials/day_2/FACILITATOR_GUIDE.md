# Facilitator guide — Day 2 morning live demo

**Session:** *From the console to a report* · **Block:** ~09:45–12:00 (≈ 2 h 15 m
with one break) · **Lead:** Jannis · **Mode:** live coding, projector + RStudio.
...
- Have `05_report.html` ready in a browser tab as a fallback for Act 4.
...
## Act 1 — The Console  ·  ~30 min  ·  `01_console_basics.R`
...
- Show `psych::describe(ages)` — *"`::` says 'this function, from this package',
  without loading the whole thing."* (glimpse from dplyr arrives in Act 2.)
...
## Act 2 — The Script  ·  ~25 min  ·  `02_first_script.R`
...
## Act 3 — Functions  ·  ~20 min  ·  `03_functions.R` + `04_script_with_functions.R`
...
- Open `03_functions.R`. **Source it** (`Cmd/Ctrl + Shift + S`). *"Nothing
  ...
  reporting helper we'll meet in Act 4) now sit under *Functions*.
...
- Run it whole. Same table, same plot as Act 2.
...
- **This is the key sentence of the morning:** *"`source()` here does for OUR
  ...
  that uses it — is exactly how the whole project is built."* Foreshadow Act 4
  and the afternoon.

---

## Act 4 — The Report  ·  ~20 min  ·  `05_report.qmd`
...
1. End of Act 1 — *"Can everyone tell a function call from an object?"*
2. End of Act 3 — *"Can everyone see why we'd write a function instead of
